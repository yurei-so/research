...
| [008](labnote-008-audible-focus-control-gate.md) | 2026-08-23 | Can post-hoc focus control create audible, natural emphasis before spending human-review labor? | Documentation reconciliation required; smooth-focus revision recorded as pending | Follows 004; tests an audible focus mechanism before listener evaluation |
