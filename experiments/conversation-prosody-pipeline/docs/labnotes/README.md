...
| [012](labnote-012-reference-conditioned-focus-transfer.md) | 2026-09-11 | Can whole-utterance reference conditioning reproduce explicitly demonstrated contrastive focus? | Planned bounded eight-output pilot | Replaces failed lexical-stress mapping with private same-speaker reference demonstrations |
