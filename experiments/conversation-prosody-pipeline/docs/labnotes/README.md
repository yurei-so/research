...
| [015](labnote-015-emergent-reading-annotation.md) | 2026-09-11 | What coherent readings emerge when direct lexical-focus control fails? | Active private annotation | Blinds and labels the eight Prosody 014 outputs as a discovery corpus for later fingerprint retrieval |
