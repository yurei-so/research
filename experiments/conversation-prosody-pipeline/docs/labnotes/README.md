...
| [017](labnote-017-multi-utterance-candidate-pool.md) | 2026-09-11 | Can a multi-utterance pool supply repeated readings for held-out retrieval? | Active generation and annotation | Generates twelve private candidates across four unseen utterances and three broad reading recipes |
