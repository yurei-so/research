...
| [013](labnote-013-qwen-instruction-focus-pilot.md) | 2026-09-11 | Can reference-free instructions produce natural, directionally correct contrastive focus? | Planned bounded eight-output pilot | Replaces failed recorded-reference conditioning with Qwen3-TTS instruction control |
