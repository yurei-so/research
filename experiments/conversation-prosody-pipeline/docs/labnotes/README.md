...
| [014](labnote-014-instruction-form-ablation.md) | 2026-09-11 | Does removing the competing focus word restore directional contrastive emphasis? | Complete negative result | Neither arm passed joint admission, but natural sarcasm and exasperation emerged outside the requested focus |
| [015](labnote-015-emergent-reading-annotation.md) | 2026-09-11 | What coherent readings emerge when direct lexical-focus control fails? | Complete mixed result | Seven of eight readings were natural, but only two named the requested focus; coherent unintended readings motivate acoustic fingerprinting |
| [016](labnote-016-acoustic-fingerprint-pilot.md) | 2026-09-11 | Do lightweight acoustic fingerprints recover perceived emphasis and expressive delivery? | Complete positive pilot | Recovered perceived focus in 5/8 clips and achieved the strongest exact neutral-versus-expressive separation among 56 label assignments |
| [017](labnote-017-multi-utterance-candidate-pool.md) | 2026-09-11 | Can a multi-utterance pool supply repeated readings for held-out retrieval? | Complete mixed result | Six natural expressive readings span all four utterances, but zero natural neutral-only readings require a four-clip control rescue |
| [018](labnote-018-conversation-conditioned-two-speaker-pilot.md) | 2026-09-12 | Can conversation-aware direction produce a convincing two-speaker exchange? | Complete positive pilot | The context-directed scene passed all four blind listener gates while isolated direction passed only turn timing |
